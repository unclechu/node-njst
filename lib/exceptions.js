...
list.push(function UnknownRenderAgrument(message) {
    base.call(this);
    this.message = message || 'Unknown render argument.';
});
...
list.push(function IncorrectInputParams(message) {
    base.call(this);
    this.message = message || 'Incorrect input params type (must be an object or null).';
});

list.push(function IncorrectCallbackArgument(message) {
    base.call(this);
    this.message = message || 'Incorrect callback argument (must be a function or null).';
});
...
list.push(function ParseTemplateSyntaxError(message) {
    base.call(this);
    this.message = message || 'Parsing template file error (syntax error).';
});
...
list.push(function NoExceptionToDebug(message) {
    base.call(this);
    this.message = message || 'No exception to debug.';
});

list.push(function IncorrectExceptionArgument(message) {
    base.call(this);
    this.message = message || 'Incorrect exception argument type.';
});

list.push(function DebuggedError(message) {
    base.call(this);
    this.message = message || 'This error was debugged.';
