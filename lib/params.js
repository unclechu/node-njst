 ...
 *
 * Arguments:
 *   inputParams [Object] ket-value object of parameters to set over defaults
 *
 * Public
 */
function Params(inputParams) {
    ...
    if (typeof inputParams !== 'undefined') this.set(inputParams);
}
